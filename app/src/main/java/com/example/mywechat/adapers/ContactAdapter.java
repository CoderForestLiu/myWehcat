...
import com.example.mywechat.utils.PingYingUtils;
...
import ContactComparator.ContactComparator;
...
public class ContactAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void handleContact() {
        ...
        for (int i = 0; i < mContactNames.length; i++) {
            String pinyin = PingYingUtils.getPingYin(mContactNames[i]);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_TYPE_CHARACTER.ordinal()) {
            ...
            return new ContactHolder(mLayoutInflater.inflate(R.layout.contactlist, parent, false));
        }
    }
    @Override
